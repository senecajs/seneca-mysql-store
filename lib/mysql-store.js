...
module.exports = function(opts) {
  ...
  function configure(specification, cb) {
    ...
    connection = mysql.createConnection({host: conf.host,
                                         user: conf.user,
  ...
  var store = {
    ...
    save: function(args, cb) {
      ...
      if (update) {
        ...
        connection.query(query, entp, function(err, result) {
    ...
    list: function(args, cb) {
      ...
      var qent = args.qent;
      var q = args.q;
      var queryfunc = makequeryfunc(qent, q, connection);
    ...
    remove: function(args, cb) {
      ...
      var qent = args.qent;
      var q = args.q;
      var query = deletestm(qent, q, connection);
